...
public class Instance
{
  ...
  List<CommandClass> commandClasses; // list of command classes of this instance. In case there is only one instance, this is equivalent to the list of command classes of the device.
